...
DOM EXPLANATION:
Document Object Model (DOM) is a platform and language-neutral interface that allows programs and scripts to dynamically
...
// Adde an EventListner on the roll-dice button
...
// Adde an EventListner on the hold button
